...
const socialLinks = [
  { icon: Github, href: "https://github.com/robina2721", label: "GitHub", color: "#333" },
  { icon: Linkedin, href: "https://www.linkedin.com/in/robsan-demisew-09408635a?utm_source=share&utm_campaign=share_via&utm_content=profile&utm_medium=android_app", label: "LinkedIn", color: "#0077B5" },
  { icon: Instagram, href: "https://www.instagram.com/robina.2721?igsh=NjBzdmxuZWxqNXF0", label: "Instagram", color: "#E4405F" },
  { icon: Send, href: "https://t.me/robina2721", label: "Telegram", color: "#0088CC" },
];
      ...
      >
        <div className="container mx-auto px-6 py-4">
          <div className="flex items-center justify-between">
            ...
            >
              <span className="animate-wave inline-block">👋</span> Robsan
            </motion.div>
      ...
      <section id="about" className="py-20 px-6 bg-muted/50 relative">
        <div className="container mx-auto">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            {[
              { icon: Code, title: "Frontend Magic", desc: "HTML, CSS, JavaScript,React", color: "#61DAFB" },
